    ...
    <article class="mx-auto max-w-5xl px-5 py-10 sm:px-8 sm:py-12">
      ...
      <section class="mt-10 border-y border-[#b9c8c4] bg-[#f2f6f4] px-4 py-6">
        ...
        <p class="mt-3 max-w-3xl text-sm leading-7 text-[#536563]">
          Recording and analysis remain local unless you opt in after viewing a result. Opted-in research sharing sends only image ID, model scores, result band, duration, broad browser family, timestamp, and consent version to Appwrite Databases. It excludes audio, transcript, full user agent, name, email, and recording files.
        </p>
      </section>
