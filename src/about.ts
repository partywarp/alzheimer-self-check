    ...
    <nav class="border-b border-line-muted bg-white">
      <div class="mx-auto flex max-w-5xl items-center justify-between gap-3 px-5 py-4 sm:px-8">
        ...
        <div class="flex shrink-0 gap-3 text-sm">
          <a href="${publicAssetUrl('science.html')}" class="font-medium text-brand-link-dark underline decoration-brand-decoration underline-offset-4 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brand">Method</a>
          <a href="${publicAssetUrl()}" class="font-medium text-brand-link-dark underline decoration-brand-decoration underline-offset-4 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brand">Exercise</a>
        </div>
      </div>
    </nav>

    <article class="mx-auto max-w-none px-0 py-0">
      <section class="md:grid md:grid-cols-[minmax(18rem,0.85fr)_minmax(22rem,1.15fr)] md:gap-8 md:bg-page-warm md:px-8 md:py-10 lg:px-10">
        <div class="relative min-h-[calc(100svh-4rem)] overflow-hidden md:flex md:min-h-0 md:flex-col md:overflow-visible">
          ...
          <header class="absolute left-0 top-0 max-w-3xl px-5 pt-8 text-ink-heading drop-shadow-[0_1px_1px_rgba(255,255,255,0.7)] sm:px-8 sm:pt-10 md:static md:order-1 md:max-w-none md:px-0 md:pt-0 md:drop-shadow-none">
            <p class="text-sm font-semibold uppercase tracking-[0.14em] md:text-brand-overline">About</p>
            <h1 class="mt-3 text-4xl leading-tight font-semibold tracking-[-0.03em] sm:text-6xl md:text-5xl lg:text-6xl">
              David Zhao
            </h1>
            <p class="mt-4 max-w-md text-lg leading-7 md:text-muted-body lg:text-xl lg:leading-8">
        ...
        <div class="px-5 py-10 sm:px-8 sm:py-12 md:px-0 md:py-0">
          <section class="py-5" aria-labelledby="bio-heading">
            <h2 id="bio-heading" class="text-xl font-semibold text-ink-heading">Personal blurb</h2>
            <div class="mt-3 space-y-3 text-sm leading-7 text-muted-body">
              ...
              <p>You can contact David at <a class="font-semibold text-brand-link-dark underline decoration-brand-decoration underline-offset-4 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brand" href="mailto:dzhao650@gmail.com">dzhao650@gmail.com</a> or using the contact form below.</p>
            </div>
          </section>

          <section class="border-t border-line-muted pt-4 pb-5" aria-labelledby="contact-heading">
            <h2 id="contact-heading" class="text-xl font-semibold text-ink-heading">Contact</h2>
            <p class="mt-3 text-sm leading-7 text-muted-body">Use the form below for questions, feedback, or project-related contact.</p>
